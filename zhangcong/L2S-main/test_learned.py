...
def main():
    ...
    for test_t in testing_type:  # select benchmark
        ...
        for p_j, p_m in zip(problem_j, problem_m):  # select problem size
            ...
            inst = np.load('/home/zyt/FJSP/zhangcong/L2S-main/test_data/{}{}x{}.npy'.format(test_t, p_j, p_m))
            ...
            if test_t != 'syn':
                ...
                gap_against = np.load('/home/zyt/FJSP/zhangcong/L2S-main/test_data/{}{}x{}_result.npy'.format(test_t, p_j, p_m))
            else:
                # ortools solver
